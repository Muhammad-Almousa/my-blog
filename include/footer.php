...
<div class="copyright">
		...
		<div class="col-lg-4 col-sm-4 text-left">
					...
					<a href="<?php echo $setting['instagram']; ?>" target="_blank"><div class="instagram-hover social-slide"></div></a>
		</div>
...
<?php close_db(); 
 ...
 ?>
   ...
   <script src="js/minu_js.js"></script>
  <script src="js/socail.js"></script>
